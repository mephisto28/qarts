...
def context_static_cache(func):
    sig = inspect.signature(func)
    default_name = sig.parameters['name'].default
    assert 'field' in sig.parameters, "Function must have 'field' parameter"
    assert 'input_value' in sig.parameters, "Function must have 'input_value' parameter"
    assert 'name' in sig.parameters, "Function must have 'name' parameter"
...
def context_timestep_cache(func):
    sig = inspect.signature(func)
    default_name = sig.parameters['name'].default
